...
class Carrito {
  ...
  finalizeOrder() {
    ...
    fetch("https://webhook.n8n.cloud/webhook/pedido-aquagt", {
      method: "POST",
      headers: {
    ...
    .catch(error => {
      console.error("Error al enviar pedido a n8n:", error);
      this.showNotification('Error al enviar a sistema, pero se envió por WhatsApp', 'error');
    });
